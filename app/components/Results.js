...
function ProfileList({ profile }) {
  return (
    ...
    <li><FaUser color='rgb(239,115,115)' size={22} /> {profile.name}</li>
    {profile.location && 
      <li><FaCompass color='rgb(144,115,255)' size={22} /> {profile.location}</li>
    }
    {profile.company &&
      <li><FaSuitcase color='#795548' size={22} /> {profile.company}</li>
    }
